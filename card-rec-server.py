...
def get_center_card(im, center):
    ...
    for card in contours:
        ...
        #imx = im.copy()
        #cv2.drawContours(imx,cv2.approxPolyDP(card,0.02*peri,True),-1,(255,255,0),6)
        #cv2.circle(imx, center, 2, (0,0,255), -1)
        #cv2.imshow('Contours',imx)
        #raw_input("")
